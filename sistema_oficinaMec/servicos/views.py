...
def gerar_os (gerar_os, identificador):
    servico = get_object_or_404 (Servico, identificador=identificador)
    ...
    pdf.cell(35, 10,'Manutenção:',1 ,0,'L', 1)
    ...
    pdf.cell(35, 10,'Início:',1 ,0,'L', 1)
    pdf.cell(0, 10,f' {servico.data_inicio}',1 ,1 ,'L', 1)

    pdf.cell(35, 10,'Prev. término:',1 ,0,'L', 1)
    ...
    pdf_bits = BytesIO(pdf_content)
    return FileResponse(pdf_bits, filename=f'os-{servico.protocolo}.pdf')
